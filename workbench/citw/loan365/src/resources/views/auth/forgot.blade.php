                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">         
                        <div class="card card-signup">
                            <form class="form" method="post" action="{{url('forgot_link')}}">
                            {{ csrf_field() }}
                                ...
                                <div class="content">
                                    <div class="input-group">
                                        ...
                                        {!!$errors->first('email','<span class="form-error" style="color: red">:message</span>')!!}
                                    </div>
                                </div>
                                <div class="footer text-center">
                                    <button href="#pablo" class="btn btn-simple btn-primary btn-lg">Submit</button>
                                </div>
